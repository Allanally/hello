           ...
           <div className="md:w-8/12 w-11/12 mt-36 min-h-fit border-2 border-blue-500 rounded-md m-auto">
            ...
            <label className="font-bold" >Student Names</label>
               ...
               <div className="flex">
                  ...
                  <select value={issuer} className="h-14 text-md md:w-6/12 w-11/12 bg-white border outline-blue-500 rounded-md border" required onChange={(e) => setIssuer(e.target.value)} >
            ...
            <option value="S6 PCM">S6 PCM</option>
               ...
               <div className="flex flex-col">
                  <label className="font-bold">Affiliate</label>
                  <input type="text" className="border indent-4 m-2 focus:outline-blue-400 rounded-md h-[5vh]" required placeholder="Enter The Affiliates Name" value={user} onChange={(e) => setUser(e.target.value)}/>
               </div>
               <br />
